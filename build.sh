...
KERNEL_NAME="SwanKernel_Gamma"
DTC="" # This one is optional, usually has the following path on Arch-based: /var/lib/snapd/snap/bin/dtc
GCC_AARCH64=$HOME/toolchains/aarch64-elf/bin/aarch64-elf-
GCC_ARM32=$HOME/toolchains/arm-eabi/bin/arm-eabi-
...
BUILD_KERNEL(){
	...
	make O=KernelOut/ ARCH=arm64 lineageos_${SELECTED_MODEL,,}_oxavelar_defconfig
...
# This is how you call a function to start the script execution, it must be outside all other functions.
GET_VARIANT
